...
public class MainActivity extends AppCompatActivity {
    ...
    private Question[] mQuestionBank = new Question[] {
            ...
            new Question(R.string.question_reliz, true),
            new Question(R.string.question_java, true),
            new Question(R.string.question_system, false),
            new Question(R.string.question_google, true),
            new Question(R.string.question_root, true),
    };
